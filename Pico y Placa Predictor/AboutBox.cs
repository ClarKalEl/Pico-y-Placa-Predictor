...
{
    partial class AboutBoxPicoYPlaca : Form
    {
        public AboutBoxPicoYPlaca()
        {
            InitializeComponent();
        ...
        private void linkLabelAmtWebPage_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            try
            {
            ...
            {
                errorProviderAboutLinkPage.SetError(linkLabelAmtWebPage,"Unable to open link that was clicked.\n"+ex.Message+"\n"+ex.StackTrace);
            }
        }
    }
}